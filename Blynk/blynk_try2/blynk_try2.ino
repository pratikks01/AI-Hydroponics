...
//char auth[] = "MQPfb_8uf-2af6IhoLgZ8fqHmySRkVvZ"; //Enter the Auth code which was send by Blink
#define BLYNK_TEMPLATE_ID "TMPLEkirbd5J"
#define BLYNK_DEVICE_NAME "Plant Monitor"
// Your WiFi credentials.
// Set password to "" for open networks.
char ssid[] = "ASUS_X01BDA";  //Enter your WIFI Name
char pass[] = "Hello1234";  //Enter your WIFI Password
